...
echo.
echo === Seedance Cinematic Desk : build EXE ===
echo.
...
taskkill /F /IM SeedanceCinematicDesk.exe >nul 2>&1
timeout /t 2 /nobreak >nul

if exist "dist\SeedanceCinematicDesk.exe" (
  del /f /q "dist\SeedanceCinematicDesk.exe" >nul 2>&1
)
if exist "dist\SeedanceCinematicDesk.exe" (
  echo [ERROR] Cannot replace dist\SeedanceCinematicDesk.exe
...
echo.
echo OK
echo EXE: "%cd%\dist\SeedanceCinematicDesk.exe"
echo.
if exist "dist\SeedanceCinematicDesk.exe" explorer dist
pause
